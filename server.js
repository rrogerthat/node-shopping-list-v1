...
const {ShoppingList} = require('./models');		//Obj destructuring?
...
Recipes.create('smoothie', ['banana', 'cocoa', 'milk', 'vanilla yogurt']);
Recipes.create('spaghetti', ['tomato sauce', 'noodles', 'sausages', 'mushroom']);
Recipes.create('omelette', ['eggs', 'onions', 'green pepper', 'potatoes']);

// when the root of this route is called with GET, return
// all current ShoppingList items by calling `ShoppingList.get()`
app.get('/shopping-list', (req, res) => {
  res.json(ShoppingList.get());								//array from model.js file
});
